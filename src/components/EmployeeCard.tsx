...
const EmployeeCard = memo(function EmployeeCard({
  ...
  const latestSR = (employee.serviceRecords || []).length > 0 ? getResolvedLatestRecord(employee.serviceRecords || []) : null;
      ...
      >
        ...
        <div className="flex-1 grid grid-cols-1 md:grid-cols-4 gap-4">
          <div className="flex flex-col">
            ...
            <h3 className="font-bold text-slate-900 truncate uppercase">
    ...
    >
      <div className="relative h-48 bg-slate-900 overflow-hidden">
        ...
        <div className="absolute bottom-4 left-4 right-4">
          <span className="text-[10px] font-black uppercase tracking-[0.2em] text-[var(--gold)] mb-1 block">
            Official Record
          </span>
      ...
      <div className="p-6 flex-1 flex flex-col gap-5">
          ...
          <div className="flex items-center gap-3 text-slate-600">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs font-bold truncate">
                {latestSR?.designation || "Unassigned"}
              </span>
            </div>
          </div>
          <div className="flex items-center gap-3 text-slate-600">
        ...
        <div className="pt-5 border-t border-slate-100 flex items-center justify-between mt-auto">
          <div className="flex -space-x-2">
            <div
              className="w-8 h-8 rounded-full bg-slate-100 border-2 border-white flex items-center justify-center text-slate-400"
