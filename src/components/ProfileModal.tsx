...
import {
  downloadFileFromDrive as downloadFileFromGDrive,
  deleteFileFromDrive,
...
export default function ProfileModal({
  ...
  const handleDownloadDriveFile = async (doc: Attachment) => {
    ...
    try {
      ...
      setDriveError(
        `Failed to download from Google Drive: ${err.message || err}`,
      );
    } finally {
  ...
  const handleDeleteAttachment = async (id: string) => {
    ...
    if (
      confirm(
        "Are you sure you want to delete this scanned document? This action cannot be undone.",
      )
    ) {
  ...
  const handleRemovePdsScan = () => {
    ...
    if (
      confirm(
        "Are you sure you want to delete the PDS scan? This action cannot be undone.",
      )
    ) {
      const updatedEmp = {
        ...employee,
  ...
  const handleExport = () => {
    const dataStr =
      ...
      encodeURIComponent(JSON.stringify(employee, null, 2));
    const downloadAnchorNode = document.createElement("a");
    downloadAnchorNode.setAttribute("href", dataStr);
    downloadAnchorNode.setAttribute(
      "download",
      `${employee.surname}_${employee.firstName}_Dossier.json`,
    );
  ...
  return (
    <div
      className={`fixed inset-0 z-50 flex items-center justify-center bg-slate-900/80 backdrop-blur-md ${isModalFullScreen ? "p-0" : "md:p-4"} print:block print:static print:bg-white print:p-0`}
      role="dialog"
      aria-modal="true"
    ...
    >
      ...
      >
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-4 md:gap-8 relative z-10 flex-grow">
            ...
            <div className="flex flex-col">
              ...
              <h2
                ...
                className="font-playfair text-2xl font-bold tracking-tight uppercase"
              >
            ...
            <div
              className="flex bg-slate-900 p-1 rounded-2xl border border-white/5 overflow-x-auto whitespace-nowrap scrollbar-none max-w-full"
              role="tablist"
        ...
        <div
          className={`flex-1 overflow-auto bg-slate-200 p-4 transition-all ${isModalFullScreen ? "md:p-6" : "md:p-12"} print:block print:p-0 print:bg-white print:overflow-visible custom-scrollbar relative`}
        >
                ...
                >
                  <div className="w-full text-black">
                    <div className="flex justify-between items-start mb-8">
                      <div className="w-20 h-20 md:w-24 md:h-24 hidden sm:block invisible"></div>{" "}
                      {/* Spacer */}
                      <div className="text-center flex-1">
                        <p className="text-[10px] md:text-xs uppercase font-bold tracking-[0.25em] text-slate-400 leading-tight">
                          Republic of the Philippines
                        </p>
                        <p className="text-xs md:text-sm uppercase font-extrabold tracking-[0.1em] text-slate-600 leading-normal">
                          MUNICIPALITY OF MAMBUSAO • PROVINCE OF CAPIZ
                        </p>
                        <h2 className="text-3xl md:text-4xl font-playfair font-black text-slate-900 tracking-wide mt-4 mb-2">
                          FILE RECORD SHEET
                        </h2>
                        <p className="text-[10px] md:text-xs uppercase tracking-wider font-bold text-slate-400 italic">
                          Official Permanent Service Record
                        </p>
                      ...
                      <div className="w-20 h-20 md:w-24 md:h-24 border-2 border-slate-900 shrink-0 bg-white p-0.5 shadow-sm hidden sm:block rounded-md overflow-hidden">
                        {employee.photo ? (
                          ...
                          <div className="w-full h-full bg-slate-50 flex items-center justify-center text-center rounded-sm">
                            <span className="text-[6px] md:text-[8px] text-slate-400 font-bold uppercase tracking-widest leading-tight">
                              Attach
                              <br />
                              Photo
                            </span>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 p-5 bg-white border border-slate-200 rounded-2xl mb-4 text-left shadow-sm">
                      <div>
                        <span className="text-[9px] uppercase font-black text-slate-500 tracking-widest block mb-1">
                          Employee Surname
                        </span>
                      ...
                      <div>
                        ...
                        <strong className="text-base font-mono text-slate-900 font-bold block">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
                      ...
                      <div className="p-4 bg-white border border-slate-200 rounded-2xl text-center shadow-sm">
                        ...
                        <strong className="text-sm font-black text-slate-900 block truncate">
                          {(employee.serviceRecords || []).length > 0 ? (getResolvedLatestRecord(employee.serviceRecords || [])?.designation || '—') : "—"}
                        </strong>
                      </div>
                      <div className="p-4 bg-white border border-slate-200 rounded-2xl text-center shadow-sm">
                        <span className="text-[8px] uppercase font-black text-slate-400 tracking-widest block mb-2">
                      ...
                      <div className="p-4 bg-emerald-50/50 border border-emerald-200 rounded-2xl text-center shadow-sm">
                        <span className="text-[8px] uppercase font-black text-emerald-600 tracking-widest block mb-2">
                          Filing Verified
                        </span>
                    ...
                    <p className="text-[10px] text-justify leading-relaxed mb-4 text-slate-600 italic">
                      ...
                      rendered services in this Government Unit as itemized
                      below in chronological sequence, supported by authorized
                      appointments:
                    </p>
                      ...
                      <table className="w-full border-collapse border border-slate-300 text-[10px] leading-normal text-center bg-white">
                        <thead>
                          <tr className="bg-slate-50 text-slate-850 font-extrabold uppercase border-b border-slate-300">
                            <th className="border border-slate-300 px-2 py-2 text-[9px] w-12 text-slate-500 font-bold">
                              S.N.
                            </th>
                            <th className="border border-slate-300 px-2 py-2 w-24">
                              inclusive from
                            </th>
                            <th className="border border-slate-300 px-2 py-2 w-24">
                              inclusive to
                            ...
                            <th className="border border-slate-300 px-2 py-2 w-20">
                              office branch
                            </th>
                        ...
                        <tbody>
                          ...
                          {(employee.serviceRecords || []).length === 0 && (
                            <tr>
                              <td
                                colSpan={11}
                                className="border border-slate-300 p-8 text-slate-400 italic text-xs text-center"
                              >
              ...
              {activeTab === "leaves" && (
                <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 pb-24">
                  ...
                  <Suspense fallback={null}>
                    <LeaveTrendsChart employee={employee} />
                  </Suspense>
                </div>
              )}
              {activeTab === "docs" && (
                  ...
                  >
                    <div className="relative mb-8 pb-4 border-b border-slate-200">
                      <div className="flex justify-between items-start">
                        <div className="w-16 h-16 md:w-20 md:h-20 hidden sm:block invisible"></div>{" "}
                        {/* Spacer */}
                        <div className="text-center flex-1">
                          <h2 className="font-playfair font-black text-2xl md:text-3xl mt-2 mb-2 text-[var(--navy)] tracking-tight uppercase">
                            SCANNED DOCUMENTS GALLERY
                          </h2>
                          <p className="text-[10px] md:text-xs font-black uppercase tracking-[0.2em] text-slate-400">
                            Official Personnel Scans & Dossier Attachments
                          </p>
                        ...
                        <button
                          onClick={() =>
                            window.dispatchEvent(
                              new CustomEvent("gers_open_drive_settings"),
                            )
                          }
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-6">
                      {(employee.attachments || []).map((doc) => (
                        <div
                          key={doc.id}
                          className="border border-slate-200 rounded-2xl p-5 bg-white shadow-sm hover:shadow-md transition-all flex flex-col justify-between"
                        >
                          <div>
                            ...
                            <div className="flex items-center gap-1.5 mb-1">
                              <h3 className="font-sans font-black text-slate-800 text-base uppercase tracking-tight truncate">
                                {doc.name}
                              </h3>
                              {doc.driveFileId && (
                          ...
                          <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                            <div className="flex flex-col">
                              <span className="text-[10px] text-slate-400 font-mono text-[9px]">
                                Uploaded:{" "}
                      ...
                      {(employee.attachments || []).length === 0 && (
                        <div className="col-span-full border-2 border-dashed border-slate-300 rounded-2xl p-16 text-center text-slate-400 w-full bg-slate-50">
                          <FileText
                            size={48}
                            className="mx-auto mb-4 opacity-30 text-slate-500"
                          />
                          <h4 className="font-sans font-bold text-lg mb-1">
                            No scanned files attached
                          </h4>
                          <p className="font-sans text-xs max-w-sm mx-auto text-slate-500">
                            This dossier currently does not contain any scanned
                            certificates, credentials, or administrative
      ...
      <div
        className={`hidden ${!showNosa ? "print:block" : ""} w-full bg-white text-black p-8 font-serif`}
      >
        <div className="w-full">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-xl font-bold tracking-wide mt-6 mb-8 uppercase">
              SERVICE RECORD
            </h2>
          </div>
          ...
          <div className="flex justify-between items-start mb-6 text-[11px] leading-relaxed">
            <div className="flex-1 max-w-3xl">
              <div className="flex items-end mb-2">
                ...
                <div className="flex-1 text-center border-b border-black font-bold uppercase">
                  {employee.surname || " "}
                </div>
                <div className="flex-1 text-center border-b border-black font-bold uppercase ml-2">
                  {employee.firstName || " "}
                </div>
                <div className="flex-1 text-center border-b border-black font-bold uppercase ml-2">
                  {employee.middleName
              ...
              <div className="flex items-start text-[9px] mb-4">
                ...
                <div className="flex-1 text-center text-gray-700 ml-2">
                  (Given Name)
                </div>
                <div className="flex-1 text-center text-gray-700 ml-2">
                  (Middle Initial)
              ...
              <div className="flex items-end mb-2">
                ...
                <div className="flex-1 text-center border-b border-black font-bold">
                  {" "}
                </div>
                <div className="flex-1 text-center border-b border-black font-bold ml-2">
                  {" "}
                </div>
            ...
            <div className="w-48 text-[9px] text-justify leading-tight ml-4">
              ...
              <br />
              <br />
              (Date herein should be checked from birth or baptismal certificate
              or some other reliable documents)
            </div>
          </div>
            ...
            <table className="w-full border-collapse border border-black text-[10px] leading-tight text-center bg-white">
              <thead>
                <tr>
                  ...
                  <th colSpan={3} className="border border-black p-1 font-bold">
                  ...
                  <th
                    rowSpan={2}
                    className="border border-black p-1 font-bold w-12 text-[9px]"
                  >
                    L/V ABS
                    <br />
                    W/O PAY
                  ...
                  <th colSpan={2} className="border border-black p-1 font-bold">
                    SEPARATION
                    <br />
                    <span className="text-[9px] font-normal">(4)</span>
                  </th>
                </tr>
                <tr>
                  <th className="border border-black p-1 font-normal text-[9px] w-16">
                    From
                  </th>
                  <th className="border border-black p-1 font-normal text-[9px] w-16">
                    To
                  </th>
                  <th className="border border-black p-1 font-normal text-[9px]">
                    Designation
                  </th>
                  <th className="border border-black p-1 font-normal text-[9px] w-12">
                    Status
                    <br />
                    (1)
                  </th>
              ...
              <tbody>
                ...
                {Array.from({
                  length: Math.max(
                    0,
                    28 - (employee.serviceRecords || []).length,
                  ),
                }).map((_, i) => (
                  <tr key={`empty-${i}`}>
                    <td className="border-x border-black px-1 py-0.5 text-center whitespace-nowrap text-transparent">
                      _
                    </td>
                    <td className="border-x border-black px-1 py-0.5 text-center whitespace-nowrap text-transparent">
                      _
                    </td>
                    <td className="border-x border-black px-1 py-0.5 text-center text-transparent">
                      _
                    </td>
                    <td className="border-x border-black px-1 py-0.5 text-center text-transparent">
                      _
                ...
                <tr>
                  <td
                    colSpan={10}
                    className="border-t border-black p-0 h-0"
                  ></td>
                </tr>
              </tbody>
            </table>
        ...
        {employee.pdsScan && (
          <div
            className="p-4 flex flex-col items-center justify-center min-h-[90vh] text-center no-print-break"
            style={{ pageBreakBefore: "always", breakBefore: "page" }}
          >
            <h3 className="text-xs font-bold uppercase tracking-wider mb-1 text-slate-700">
              Scanned Personal Data Sheet (PDS)
            </h3>
            <p className="text-[9px] text-slate-400 mb-4">
              Official Document Scan of {employee.firstName} {employee.surname}
            </p>
            {employee.pdsScan.startsWith("data:image/") ? (
              <img
                src={employee.pdsScan}
                alt="PDS Scan Image"
                className="max-w-full h-auto max-h-[85vh] object-contain border border-slate-300 shadow-sm"
              />
        ...
        {(employee.attachments || []).map((doc) => {
          return (
            ...
            >
              ...
              <p className="text-[9px] text-slate-400 mb-4">
                Scanned Attachment: {doc.fileName}
              </p>
              ...
              {doc.fileType.startsWith("image/") ? (
                <img
                  ...
                  alt={doc.name}
                  className="w-full h-auto max-h-[85vh] object-contain border border-slate-300 shadow-sm"
                  referrerPolicy="no-referrer"
                />
                ...
                <iframe
                  src={
                    doc.driveWebViewLink
                      ? doc.driveWebViewLink.replace("/view", "/preview")
                      : doc.fileData
                  }
                  className="w-full h-[85vh] border border-slate-300 shadow-sm"
                  title={doc.name}
        ...
        {isFullScreenPds && employee.pdsScan && (
          ...
          >
            <div className="w-full flex justify-between items-center text-white select-none">
              <div className="flex flex-col">
                <h2 className="font-playfair text-xl font-bold uppercase">
                  {employee.surname}, {employee.firstName}{" "}
                  {employee.middleName
                ...
                <p className="text-[9px] font-bold tracking-widest uppercase text-slate-400">
                  Personal Data Sheet Worksheet Scan
                </p>
              </div>
              <div className="flex items-center gap-3">
                <a
                  ...
                  download={
                    employee.pdsScan.startsWith("data:image/")
                      ? `${employee.surname}_PDS_Scan.png`
                      : `${employee.surname}_PDS_Scan.pdf`
                  }
